...
class ZModule(object):
  ...
  def all_verses_in_book(self, book, chapter):
    ...
    for verse in range(book.chapter_lengths[chapter-1]):
      verse = verse+1
      text.append(self.text_for_index(book.testament, book.get_index_for_ref(chapter, verse)))
...
testaments = {
    'ot': [
        ...
        Book('1 Samuel', '1Sam', '1Sam', [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 42, 15, 23, 29, 22, 44, 25, 12, 25, 11, 31, 13]),
        Book('2 Samuel', '2Sam', '2Sam', [27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 33, 43, 26, 22, 51, 39, 25]),
        Book('1 Kings', '1Kgs', '1Kgs', [53, 46, 28, 34, 18, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43, 29, 53]),
        Book('2 Kings', '2Kgs', '2Kgs', [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 21, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30]),
        Book('1 Chronicles', '1Chr', '1Chr', [54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40, 14, 17, 29, 43, 27, 17, 19, 8, 30, 19, 32, 31, 31, 32, 34, 21, 30]),
        Book('2 Chronicles', '2Chr', '2Chr', [17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 22, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23]),
    ...
    'nt': [
        ...
        Book('1 Corinthians', '1Cor', '1Cor', [31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31, 13, 40, 58, 24]),
        Book('2 Corinthians', '2Cor', '2Cor', [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14]),
        ...
        Book('1 Thessalonians', '1Thess', '1Thess', [10, 20, 13, 18, 28]),
        Book('2 Thessalonians', '2Thess', '2Thess', [12, 17, 18]),
        Book('1 Timothy', '1Tim', '1Tim', [20, 15, 16, 16, 25, 21]),
        Book('2 Timothy', '2Tim', '2Tim', [18, 26, 17, 22]),
        ...
        Book('1 Peter', '1Pet', '1Pet', [25, 25, 22, 19, 14]),
        Book('2 Peter', '2Pet', '2Pet', [21, 22, 18]),
        Book('1 John', '1John', '1John', [10, 29, 24, 21, 21]),
        Book('2 John', '2John', '2John', [13]),
        Book('3 John', '3John', '3John', [14]),
